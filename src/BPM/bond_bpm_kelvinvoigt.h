...
#ifdef BOND_CLASS
// clang-format off
BondStyle(bpm/kelvinvoigt,BondBPMKelvinVoigt);
// clang-format on
#else

#ifndef LMP_BOND_BPM_KELVINVOIGT_H
#define LMP_BOND_BPM_KELVINVOIGT_H

#include "bond_bpm.h"

namespace LAMMPS_NS {

class BondBPMKelvinVoigt : public BondBPM {
 public:
  BondBPMKelvinVoigt(class LAMMPS *);
  ~BondBPMKelvinVoigt() override;
