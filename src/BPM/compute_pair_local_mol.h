...
#ifdef COMPUTE_CLASS
// clang-format off
ComputeStyle(pair/local/mol,ComputePairLocalMol);
// clang-format on
#else

#ifndef LMP_COMPUTE_PAIR_LOCAL_MOL_H
#define LMP_COMPUTE_PAIR_LOCAL_MOL_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputePairLocalMol : public Compute {
 public:
  ComputePairLocalMol(class LAMMPS *, int, char **);
  ~ComputePairLocalMol();
  void init();
